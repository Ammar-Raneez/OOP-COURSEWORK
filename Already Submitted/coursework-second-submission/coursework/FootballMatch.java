...
/**
 * oop.cw.FootballMatch class, which will be used to represent any match between two Football clubs
 * @version 1.x November 9th 2020
 * @author Ammar Raneez | 2019163 | W1761196
 */
public class FootballMatch implements Serializable, Comparable<FootballMatch> {
    //*serialization happened to refer to a different serial id for objects of oop.cw.FootballMatch, therefore*//
     ...
     * This function is called in the oop.cw.PremierLeagueManager class in the addMatch() method
...
//    }
    ...
    /**
     * Overrun equals method to check for any oop.cw.FootballMatch equality
     ...
     * @param o - compare this oop.cw.FootballMatch with o
