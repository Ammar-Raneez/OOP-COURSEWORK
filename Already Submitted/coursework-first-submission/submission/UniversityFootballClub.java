 ...
 */
public class UniversityFootballClub implements Serializable, Comparable<UniversityFootballClub> {
     ...
     * @param o - compare this UniversityFootballClub with o
     * @return - +ve value if this clubs points > o's points, -ve value if vice-versa, 0 if equal
     */
    @Override
    public int compareTo(UniversityFootballClub o) {
        return this.getFootballClubTotalStatistics().getPoints() - o.getFootballClubTotalStatistics().getPoints();
    }

    /**
     * Overridden equals() method, to check for equality between this UniversityFootballClub and o
     * Not all attributes are to be checked for equality, since Kit, amountOfPlayers, lecturerInCharge and club net worth
