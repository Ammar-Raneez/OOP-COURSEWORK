...
/*
 * oop.cw.SingleMatchFootballClubStatistic
...
/**
 * oop.cw.SingleMatchFootballClubStatistic class, which will be used to represent any football clubs single match statistic
...
public class SingleMatchFootballClubStatistic implements Serializable {
    ...
    public String toString() {
        return "oop.cw.SingleMatchFootballClubStatistic{" +
                "corners=" + corners +
                ", fouls=" + fouls +
                ", goals=" + goals +
                ", offsides=" + offsides +
